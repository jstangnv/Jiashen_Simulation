...
frq_carrier_detuningsigma = 10 #MHz
frq_carrier_detuningpts = 2
...
frq_sidebanddetuning_central = 1.51 # MHz
frq_sidebanddetuning_detuningsigma = 0.5 #MHz
frq_sidebanddetuning_detuningpts = 3
...
#fname_savequtip = "carrier Omega "+str(Bcarrier)+' side Omega '+str(Bsideband)+' t '+str(t_pulse)
